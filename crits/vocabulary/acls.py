...
class ScreenshotACL(vocab):
    ...
    READ = SCREENSHOT + Common.READ
    WRITE = SCREENSHOT + Common.WRITE
    DELETE = SCREENSHOT + Common.DELETE
    DOWNLOAD = SCREENSHOT + Common.DOWNLOAD

    DESCRIPTION_READ = SCREENSHOT + Common.DESCRIPTION_READ
    DESCRIPTION_EDIT = SCREENSHOT + Common.DESCRIPTION_EDIT

    ACTIONS_READ = SCREENSHOT + Common.ACTIONS_READ
    ACTIONS_ADD = SCREENSHOT + Common.ACTIONS_ADD
    ACTIONS_EDIT = SCREENSHOT + Common.ACTIONS_EDIT
    ACTIONS_DELETE = SCREENSHOT + Common.ACTIONS_DELETE

    BUCKETLIST_READ = SCREENSHOT + Common.BUCKETLIST_READ
    BUCKETLIST_EDIT = SCREENSHOT + Common.BUCKETLIST_EDIT

    CAMPAIGNS_READ = SCREENSHOT + Common.CAMPAIGNS_READ
    CAMPAIGNS_ADD = SCREENSHOT + Common.CAMPAIGNS_ADD
    CAMPAIGNS_EDIT = SCREENSHOT + Common.CAMPAIGNS_EDIT
    CAMPAIGNS_DELETE = SCREENSHOT + Common.CAMPAIGNS_DELETE

    COMMENTS_READ = SCREENSHOT + Common.COMMENTS_READ
    COMMENTS_ADD = SCREENSHOT + Common.COMMENTS_ADD
    COMMENTS_EDIT = SCREENSHOT + Common.COMMENTS_EDIT
    COMMENTS_DELETE = SCREENSHOT + Common.COMMENTS_DELETE

    LOCATIONS_READ = SCREENSHOT + Common.LOCATIONS_READ
    LOCATIONS_ADD = SCREENSHOT + Common.LOCATIONS_ADD
    LOCATIONS_EDIT = SCREENSHOT + Common.LOCATIONS_EDIT
    LOCATIONS_DELETE = SCREENSHOT + Common.LOCATIONS_DELETE

    OBJECTS_READ = SCREENSHOT + Common.OBJECTS_READ
    OBJECTS_ADD = SCREENSHOT + Common.OBJECTS_ADD
    OBJECTS_EDIT = SCREENSHOT + Common.OBJECTS_EDIT
    OBJECTS_DELETE = SCREENSHOT + Common.OBJECTS_DELETE

    RELATIONSHIPS_READ = SCREENSHOT + Common.RELATIONSHIPS_READ
    RELATIONSHIPS_ADD = SCREENSHOT + Common.RELATIONSHIPS_ADD
    RELATIONSHIPS_EDIT = SCREENSHOT + Common.RELATIONSHIPS_EDIT
    RELATIONSHIPS_DELETE = SCREENSHOT + Common.RELATIONSHIPS_DELETE

    RELEASABILITY_READ = SCREENSHOT + Common.RELEASABILITY_READ
    RELEASABILITY_ADD = SCREENSHOT + Common.RELEASABILITY_ADD
    RELEASABILITY_DELETE = SCREENSHOT + Common.RELEASABILITY_DELETE

    SECTORS_READ = SCREENSHOT + Common.SECTORS_READ
    SECTORS_EDIT = SCREENSHOT + Common.SECTORS_EDIT

    SERVICES_READ = SCREENSHOT + Common.SERVICES_READ
    SERVICES_EXECUTE = SCREENSHOT + Common.SERVICES_EXECUTE
    ...
    STATUS_READ = SCREENSHOT + Common.STATUS_READ
    STATUS_EDIT = SCREENSHOT + Common.STATUS_EDIT

    TICKETS_READ = SCREENSHOT + Common.TICKETS_READ
    TICKETS_ADD = SCREENSHOT + Common.TICKETS_ADD
    TICKETS_EDIT = SCREENSHOT + Common.TICKETS_EDIT
    TICKETS_DELETE = SCREENSHOT + Common.TICKETS_DELETE
